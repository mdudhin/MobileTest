...
import Item from './TopRatedTvItem';
import {useDispatch, useSelector} from 'react-redux';
import {getTopRatedTv} from '../redux/Action/TvAction';
import {Icon} from 'react-native-elements';

export default function TopRatedTv({navigation}) {
  ...
  const tv = showOnTheAirState.topRatedTv;
  const loading = showOnTheAirState.loadingTopRatedTv;
