...
import {getNowPlayingMovie} from '../redux/Action/MovieAction';
...
export default function Carousel({navigation}) {
  ...
  const movie = showUpComingMovieState.nowPlayingMovie;
  const loading = showUpComingMovieState.loadingNowPlayingMovie;
